...
PRINT "%                                                                              %"
LOCATE 14, 24
PRINT "%                Alpha    Version 8.04a Release Candidate--RC8                 %"
LOCATE 15, 24
PRINT "%                                                                              %"
LOCATE 16, 24
...
CLS
PRINT
PRINT "BBS Menu Color Scheme Creator 8.0a Alpha Version RC8"
...
basecol3:
basesel$ = "Background color for '[' and ']' symbols."
GOSUB background
PRINT
INPUT "Enter Background color for '[' and ']' symbols : ", selection
selection1a = selection
IF selection1a > 7 AND display = "syn" OR selection1a > 7 AND display = "ansi" THEN GOTO basecol3
IF selection1a > 15 THEN GOTO basecol3
lastsel = selection
basesel$ = "Foreground color for '[' and ']' symbols."
GOSUB background
PRINT

INPUT "Enter Foreground color for '[' and ']' symbols : ", selection
selection2a = selection
IF selection2a > 7 AND display = "syn" OR selection2a > 7 AND display = "ansi" THEN GOTO basecol3
IF selection2a > 15 THEN GOTO basecol3
lastsel = selection
basecol:

basesel$ = "Inside Box Line Background Color Selection."
GOSUB background
PRINT
INPUT "Inside Box Line Background Color Selection : ", selection 'a background color selection
selection1a = selection
IF selection1b > 7 AND display = "syn" OR selection1b > 7 AND display = "ansi" THEN GOTO basecol
IF selection1b > 15 THEN GOTO basecol
lastsel = selection
basesel$ = "Inside Box Line Foreground Color Selection."
GOSUB background
PRINT
INPUT "Inside Box Line Foreground Color Selection : ", selection 'a foreground color selection
selection2b = selection
IF selection2b > 7 AND display = "syn" OR selection2b > 7 AND display = "ansi" GOTO basecol
IF selection2b > 15 THEN GOTO basecol
lastsel = selection
basecol2:
basesel$ = "Lines and corners Frame Background Color."
GOSUB background
PRINT
INPUT "Lines and corners Frame Background Color : ", selection ' Lines Background color
selection1c = selection
IF selection1c > 7 AND display = "syn" OR selection1c > 7 AND display = "ansi" THEN GOTO basecol2
IF selection1c > 15 THEN GOTO basecol2
lastsel = selection
basesel$ = "Lines and corners Frame Foreground Color."
GOSUB background
PRINT
INPUT "Lines and corners Frame Foreground Color : ", selection ' Lines Foreground color
selection2c = selection
IF selection2c > 7 AND display = "syn" OR selection2c > 7 AND display = "ansi" THEN GOTO basecol2
IF selection2c > 15 THEN GOTO basecol2
lastsel = selection
CLS
PRINT
...
PRINT
PRINT "Thank you for using BBS Menu Color Scheme Creator 8.0a RC8."
PRINT
END
pick:
RANDOMIZE TIMER
...
END IF
IF display = "wc8" AND flag$ = "Y" THEN
...
specialcharacters3:
b$ = b
IF b$ = CHR$(94) THEN flag$ = "Y2"
IF b$ = CHR$(43) THEN flag$ = "Y2"
IF b$ = CHR$(37) THEN flag$ = "Y2"
IF b$ = CHR$(126) THEN flag$ = "Y2"
IF b$ = CHR$(45) THEN
    flag$ = "Y2"
END IF
IF b$ = CHR$(91) THEN
...
IF firstrun = 0 THEN
    ...
    code$ = "None"
END IF
PRINT "Last Color Selected Was : "; colord$: PRINT "Last Code  Selected Was : "; LTRIM$(code$)
firstrun = 1
RETURN
specialcharacters2:
b$ = b
